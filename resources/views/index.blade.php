...
<html xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('resources/views/ionic/css/ionic.min.css')}}" type="text/css" charset="utf-8">
        ...
        <script src="{{asset('resources/views/js/shopcontroller.js')}}"></script>
        <script src="{{asset('resources/views/js/usercontroller.js')}}"></script>
        <script src="{{asset('resources/views/js/spreadcontroller.js')}}"></script>
        <script src="{{asset('resources/views/js/paycontroller.js')}}"></script>
